...
const ServiceDetailPage = () => {
  ...
  const service = SERVICES_DATA.find((s) => {
    ...
    return String(slug) === String(serviceId);
  });
      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-600 via-cyan-500 to-green-500 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 font-light">{service.shortDescription || serviceDescription}</p>
            <p className="text-lg max-w-3xl mx-auto mb-10">{service.fullDescription || serviceDescription}</p>
            <Link to="/contact">
              <motion.button
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">{service.shortDescription || serviceDescription}</p>
          </motion.div>
