...
import akm from "../assets/team/akm.jpg";
...
const DEFAULT_TEAM = [
  ...
  },
  {
    ...
    description:
      "Backend specialist with expertise in cutting-edge web solutions",
    linkedin: "#",
    email: "#",
  },
  {
...
const AboutPage = () => {
  ...
  const teamMembers = gj(c, "about", "team", DEFAULT_TEAM).map((m) => ({
    ...m,
    image: LOCAL_IMAGES[m.imageKey] || sd,
  }));
    ...
    <div className="min-h-screen bg-white pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              {g(c, "about", "teamHeading", "Meet Our Team")}
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                <div
                  className={`relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 h-full`}
                >
                  ...
                  <div className="relative p-6">
                    ...
                    <div className="mb-6 flex justify-center">
                      <div className="relative">
                        ...
                        <div
                          className={`absolute inset-0 bg-gradient-to-br ${member.gradient} rounded-full blur-xl opacity-0 group-hover:opacity-60 transition-opacity duration-500 scale-110`}
                        />

                        {/* Gradient border */}
                        <div
                          className={`relative p-1 bg-gradient-to-br ${member.gradient} rounded-full`}
                        >
                          <motion.div
                  ...
                  <div
                    className={`absolute -top-16 -right-16 w-32 h-32 bg-gradient-to-br ${member.gradient} rounded-full opacity-0 group-hover:opacity-20 blur-3xl transition-opacity duration-500`}
                  />
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              {g(c, "about", "ctaHeading", "Ready to Work With Us?")}
            </h2>
